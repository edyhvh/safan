    ...
    <>
      ...
      {!isHidden && (
        <nav
          ...
          onMouseLeave={handleNavbarMouseLeave}
        >
      <div className={`flex items-center gap-2 px-3 py-2 rounded-lg neumorphism navbar-container transition-transform duration-300 ease-out ${
        ...
        {(showFullNavbar || showLogoOnly) && (
          ...
          >
            ...
            <div
              ...
              onMouseLeave={handleBooksMouseLeave}
            >
              <div className={`books-dropdown-float ${booksDropdownOpen ? 'open' : ''}`}>
                <BooksDropdown
